exports.scrapeTableDate = function (url, callback) {
        ...
        $('tbody tr').each((i, el) => {
          ...
          if (i == 0) {
            teamRow = {
              ...
              wins: parseInt($(el).find('td:nth-child(5)').text()),
              draws: parseInt($('td:nth-child(6)', el).text()),
              losses: parseInt($('td:nth-child(7)', el).text()),
